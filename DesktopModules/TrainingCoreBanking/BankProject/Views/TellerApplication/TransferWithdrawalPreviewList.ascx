...
<telerik:RadGrid runat="server" AutoGenerateColumns="False" ID="radGridReview" AllowPaging="True" OnNeedDataSource="radGridReview_OnNeedDataSource">
    <MasterTableView>
        <Columns>
            ...
            <telerik:GridBoundColumn HeaderText="Debit Account Code" HeaderStyle-Width = "11%" DataField="DebitAccount" />
            ...
            <telerik:GridBoundColumn HeaderText="Credit Account Code" HeaderStyle-Width = "11%" DataField="CreditAccount" />
            ...
            <telerik:GridTemplateColumn>
                <ItemStyle Width="25" />
                <ItemTemplate>  
                    <a href='Default.aspx?tabid=126&preview=1&codeid=<%# Eval("Code").ToString() %>'><img src="Icons/bank/text_preview.png" alt="" title="" style="" /> </a> 
                </itemtemplate>
            </telerik:GridTemplateColumn>
        </Columns>
    </MasterTableView>    
