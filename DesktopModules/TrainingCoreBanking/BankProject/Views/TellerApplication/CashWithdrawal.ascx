...
<script type="text/javascript">
    ...
    function OnClientButtonClicking(sender, args) {
        ...
        if (button.get_commandName() == "print" && !clickCalledAfterRadconfirm) {
            ...
            radconfirm("Do you want to download Cash Withdrawal file?", confirmPrintDeal, 340, 150, null, 'Download');
        }
    }
    ...
    function confirmPrintDeal(result) {
        ...
        radconfirm("Do you want to download Non Term Saving Account file?", confirmLOpenAccount, 340, 150, null, 'Download');
    }

    function confirmLOpenAccount(result) {
        clickCalledAfterRadconfirm = false;
        if (result) {
