<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChequeWithDrawal_Enquiry.ascx.cs" Inherits="BankProject.Views.TellerApplication.ChequeWithDrawal_Enquiry" %>
...
<div style="padding:10px;">
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="MyLable">WithDrawal ID:</td>
            <td class="MyContent" >
                <telerik:radtextbox  id="tbWithdrawalID" runat="server" validationGroup="Group1" ></telerik:radtextbox>
            </td>
        ...
        <tr>
            ...
            <td class="MyLable">Withdrawal Date:</td>
            <td class="MyContent">
        ...
        <tr>
            ...
            <td class="MyContent">
                <telerik:RadComboBox id="rcbChequeType" Allowcustomtext="false" MarkFirstMatch="true" AppendDataBoundItems="true"  runat="server">
                   <Items>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
            <td class="MyLable">Withdrawal Amount:</td>
             <td class="MyContent" style="visibility:hidden;">
