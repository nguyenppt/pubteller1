...
/****** Object:  StoredProcedure [dbo].[BCASHWITHRAWAL_Print_GetByCode]    Script Date: 21/11/2014 11:04:27 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	select 
		...
		, un.Narrative
		, un.Amount
		,un.CurrencyPaid, dbo.f_CurrencyToText(AmountPaid,un.CurrencyPaid ) as NumberWords
