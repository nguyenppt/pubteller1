...
namespace BankProject.Views.TellerApplication.ForeignExchange
{
    public partial class BuyTravellersCheque : PortalModuleBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //
            bc.Commont.initRadComboBox(ref rcbDrAccount, "Display", "Account", bd.Teller.InternalBankPaymentAccount("1011"));
            bc.Commont.initRadComboBox(ref rcbCrAccount, "Display", "Account", bd.Teller.InternalBankAccount());
            //
