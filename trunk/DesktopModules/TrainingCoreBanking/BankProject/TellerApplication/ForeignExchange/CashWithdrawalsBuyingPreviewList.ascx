<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CashWithdrawalsBuyingPreviewList.ascx.cs" Inherits="BankProject.Views.TellerApplication.ForeignExchange.CashWithdrawalsBuyingPreviewList" %>
