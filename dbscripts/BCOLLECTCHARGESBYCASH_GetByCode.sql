...
/****** Object:  StoredProcedure [dbo].[BCOLLECTCHARGESBYCASH_GetByCode]    Script Date: 09/10/2014 3:08:30 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[BCOLLECTCHARGESBYCASH_GetByCode]
	@Code nvarchar(20)
AS
BEGIN
	...
	(
		...
		, ValueDate, CategoryPLCode, CategoryPLName, a.DealRate, VatAmountFCY,VatAmountLCY,ISNULL(NULLIF(VatAmountFCY, 0), VatAmountLCY) VatAmount,TotalAmountFCY,TotalAmountFCY, ISNULL(NULLIF(TotalAmountFCY, 0), TotalAmountLCY) TotalAmount, a.Narrative, VatSerialNo,
							  a.CreateBy, a.CreateDate, a.UpdatedBy, a.UpdatedDate, a.AuthorizedBy, a.AuthorizedDate, a.Status, a.CustomerName, a.CUstomerName_vanglai
		 from dbo.BCOLLECTCHARGESBYCASH a
